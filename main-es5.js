...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _pop_up_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./pop-up.service */ "./src/app/_services/pop-up.service.ts");
            var MarkerService_1;
            var MarkerService = MarkerService_1 = /** @class */ (function () {
                function MarkerService(http, popupService) {
                    this.http = http;
                    this.popupService = popupService;
                    this.capitals = '/assets/data/europe-capitals.geojson';
                }
                MarkerService.ScaledRadius = function (val, maxVal) {
                    return 20 * (val / maxVal);
                };
                MarkerService.prototype.makeCapitalsMarkers = function (map) {
                    this.http.get(this.capitals).subscribe(function (res) {
                        var e_1, _a;
                        try {
                            for (var _b = __values(res.features), _c = _b.next(); !_c.done; _c = _b.next()) {
                                var c = _c.value;
                                var lat = c.geometry.coordinates[0];
                                var lon = c.geometry.coordinates[1];
                                var marker = leaflet__WEBPACK_IMPORTED_MODULE_3__["marker"]([lon, lat]).addTo(map);
                            }
                        }
                ...
                MarkerService.prototype.makeCapitalsCircleMarkers = function (map) {
                    var _this = this;
                    this.http.get(this.capitals).subscribe(function (res) {
                        var e_2, _a;
                        // Find the maximum population to scale the radii by.
                        var maxVal = Math.max.apply(Math, __spread(res.features.map(function (x) { return x.properties.population; }), [0]));
                        try {
                            for (var _b = __values(res.features), _c = _b.next(); !_c.done; _c = _b.next()) {
                                var c = _c.value;
                                var lat = c.geometry.coordinates[0];
                                ...
                                var circle = leaflet__WEBPACK_IMPORTED_MODULE_3__["circleMarker"]([lon, lat], {
                                    radius: MarkerService_1.ScaledRadius(c.properties.population, maxVal),
                                }).addTo(map);
            ...
            MarkerService = MarkerService_1 = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
            ...
            var PopUpService = /** @class */ (function () {
                ...
                PopUpService.prototype.makeCapitalPopup = function (data) {
                    return ("" +
                        ...
                        ("<div>Population: " + data.properties.population.toLocaleString('en-us') + "</div>"));
                };
                return PopUpService;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _services_marker_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./_services/marker.service */ "./src/app/_services/marker.service.ts");
            /* harmony import */ var _services_pop_up_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./_services/pop-up.service */ "./src/app/_services/pop-up.service.ts");
            /* harmony import */ var _services_shape_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./_services/shape.service */ "./src/app/_services/shape.service.ts");
            ...
            AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
                Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
                    ...
                    providers: [_services_marker_service__WEBPACK_IMPORTED_MODULE_6__["MarkerService"], _services_pop_up_service__WEBPACK_IMPORTED_MODULE_7__["PopUpService"], _services_shape_service__WEBPACK_IMPORTED_MODULE_8__["ShapeService"]],
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            "use strict";
            __webpack_require__.r(__webpack_exports__);
            /* harmony default export */ __webpack_exports__["default"] = (".map-container {\n  position: absolute;\n  top: 0;\n  left: 0;\n  right: 0;\n  bottom: 0;\n  margin: 30px;\n}\n\n.map-frame {\n  border: 2px solid black;\n  height: 100%;\n}\n\n#map {\n  height: 100%;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
            /***/ 
        }),
        ...
        /***/ (function (module, exports, __webpack_require__) {
            module.exports = __webpack_require__(/*! C:\Mis Proyectos\BIEL_PRUEBAS\_ANGULAR\leaflet-example\src\main.ts */ "./src/main.ts");
            /***/ 
        })
    }, [[0, "runtime", "vendor"]]]);
